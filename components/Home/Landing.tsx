    ...
    <main className='h-[100dvh] pt-20 bg-gradient-to-r from-[#F5F5F5] to-[#b0d4e3b2] overflow-hidden '>
      <div className='grid grid-cols-[2fr_1fr] h-[80%] w-full '>
        <div className='b w-full p-10 content-center'>
          <p className='text-6xl font-medium w-[80%] font-crimson text-[#5D8AA8]'>Grow in Grace with <span className='bg-gradient-to-tr from-[#E6C17C] to-[#d6a13e] text-transparent bg-clip-text'>Trusted</span> Christian Literature</p>
