      ...
      <div className='grid grid-cols-[2fr_1fr] h-[80%] w-full '>
        <div className='b w-full p-10 content-center'>
          ...
          <div className='mt-10 flex gap-4'>
            <button className='px-10 py-4 bg-gradient-to-r from-[#5a88a7] to-[#426074] text-white hover:shadow-lg rounded-lg cursor-pointer  transition duration-300 hover:bg-[#426074] hover: flex items-center gap-2 group poppins font-medium antialiased'>Explore Bookstore
